...
#
# Generated by export_simulation on Sat Jul 14 14:20:57 +0800 2018
#
################################################################################
...
switch to the './InOutBuffer.sh' script.

./InOutBuffer.sh -reset_run
...
./InOutBuffer.sh -noclean_files

For more information on the script, please type './InOutBuffer.sh -help'.
